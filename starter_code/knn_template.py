...
file_path = r"C:\Users\l\Desktop\gi\-\datingTestSet2.txt"
...
def datingClassTest():
    ...
    for i in range(numTestVecs):  
        ...
        print(f"分类器预测结果: {classifierResult}, 真实结果: {datingLabels[i]}")  
...
def classify_person():
    ...
    try:
        ...
        ice_cream = float(input("每周消费的冰淇淋的公升数："))
    except ValueError:
        print("输入必须是数字，请重新尝试。")
        return True
    ...
    norm_in_arr = (in_arr - minVals) / ranges

    classifier_result = classify0(norm_in_arr, normMat, datingLabels, 3)
